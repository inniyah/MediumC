...
typedef enum {CONST,VARIABLE,ARRAY,POINTER,FUNCTION,PROTOTYPE,IDENT} T_ident;

/* possible entries for "type" */
typedef enum {none,CHAR,INT,FLOAT,VOID,ENUM,STRUCT,UNION} T_type;

/* possible entries for storage  KLASA*/
typedef enum {PUBLIC,AUTO,EXTERN,STATIC,LSTATIC,DEFAUTO,TYPEDEF} T_storage;

/* statement types (tokens) */
typedef enum {STIF,STWHILE,STRETURN,STBREAK,STCONT,STASM,
							STEXP,STDO,STFOR,STSWITCH} T_tokens;
...
typedef enum {WSWHILE,WSFOR,WSDO,WSSWITCH} T_wstyp;
